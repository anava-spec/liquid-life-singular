...
- You can now sort tasks on the Tasks page: click a column header in List view to sort by it (click again to reverse the order), or use the new sort box next to the search bar in Kanban view. Sorting carries over when you switch between List and Kanban.
